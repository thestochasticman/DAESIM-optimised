...
def get_time_and_output_previous():
  from daesim.biophysics_funcs import _diurnal_temperature as f
  start = time()
  output = f(10.0, 30.0, 6.5, 20.25, 0.5)
  end = time()
  return (end - start), output

def get_time_and_output_new():
  from daesim_optimised.biophysics_funcs import _diurnal_temperature as f
  start = time()
  output = f(10.0, 30.0, 6.5, 20.25, 0.5)
  end = time()
  return (end - start), output
